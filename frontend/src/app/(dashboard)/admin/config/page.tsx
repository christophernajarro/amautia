      ...
      <Dialog open={!!editing} onOpenChange={(open) => !open && setEditing(null)}>
        <DialogContent>
          ...
          <div className="space-y-4">
            ...
            <Button onClick={handleSave} disabled={updateConfig.isPending} title={updateConfig.isPending ? "Guardando..." : undefined} className="w-full bg-indigo-600 hover:bg-indigo-700 text-white">
